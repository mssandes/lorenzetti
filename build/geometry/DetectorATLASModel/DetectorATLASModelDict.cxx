...
#define R__DICTIONARY_FILENAME DetectorATLASModelDict
...
#include "/home/marton.sandes/lzt/lorenzetti/geometry/DetectorATLASModel/src/DetectorATLASConstruction.h"
#include "src/DetectorATLASConstruction.h"

// Header files passed via #pragma extra_include

namespace ROOT {
   static TClass *DetectorATLASConstruction_Dictionary();
   static void DetectorATLASConstruction_TClassManip(TClass*);
   static void delete_DetectorATLASConstruction(void *p);
   static void deleteArray_DetectorATLASConstruction(void *p);
   static void destruct_DetectorATLASConstruction(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::DetectorATLASConstruction*)
   {
      ::DetectorATLASConstruction *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TIsAProxy(typeid(::DetectorATLASConstruction));
      static ::ROOT::TGenericClassInfo 
         instance("DetectorATLASConstruction", "src/DetectorATLASConstruction.h", 18,
                  typeid(::DetectorATLASConstruction), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &DetectorATLASConstruction_Dictionary, isa_proxy, 4,
                  sizeof(::DetectorATLASConstruction) );
      instance.SetDelete(&delete_DetectorATLASConstruction);
      instance.SetDeleteArray(&deleteArray_DetectorATLASConstruction);
      instance.SetDestructor(&destruct_DetectorATLASConstruction);
      return &instance;
   }
   TGenericClassInfo *GenerateInitInstance(const ::DetectorATLASConstruction*)
   {
      return GenerateInitInstanceLocal((::DetectorATLASConstruction*)0);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::DetectorATLASConstruction*)0x0); R__UseDummy(_R__UNIQUE_DICT_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *DetectorATLASConstruction_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal((const ::DetectorATLASConstruction*)0x0)->GetClass();
      DetectorATLASConstruction_TClassManip(theClass);
   return theClass;
   }
...
namespace ROOT {
   ...
   static void delete_DetectorATLASConstruction(void *p) {
      delete ((::DetectorATLASConstruction*)p);
   }
   static void deleteArray_DetectorATLASConstruction(void *p) {
      delete [] ((::DetectorATLASConstruction*)p);
   }
   static void destruct_DetectorATLASConstruction(void *p) {
      typedef ::DetectorATLASConstruction current_t;
      ((current_t*)p)->~current_t();
   }
} // end of namespace ROOT for class ::DetectorATLASConstruction

namespace {
  void TriggerDictionaryInitialization_libDetectorATLASModel_Impl() {
    static const char* headers[] = {
"/home/marton.sandes/lzt/lorenzetti/geometry/DetectorATLASModel/src/DetectorATLASConstruction.h",
0
    };
...
"/home/marton.sandes/lzt/lorenzetti/geometry/DetectorATLASModel",
"/home/marton.sandes/lzt/lorenzetti/geometry/DetectorATLASModel/../../core/GaugiKernel",
"/home/marton.sandes/lzt/lorenzetti/geometry/DetectorATLASModel/../../core/G4Kernel",
"/opt/root/buildthis/include",
"/home/marton.sandes/lzt/lorenzetti/build/geometry/DetectorATLASModel/",
0
    };
    static const char* fwdDeclCode = R"DICTFWDDCLS(
#line 1 "libDetectorATLASModel dictionary forward declarations' payload"
#pragma clang diagnostic ignored "-Wkeyword-compat"
#pragma clang diagnostic ignored "-Wignored-attributes"
#pragma clang diagnostic ignored "-Wreturn-type-c-linkage"
extern int __Cling_Autoloading_Map;
class __attribute__((annotate("$clingAutoload$src/DetectorATLASConstruction.h")))  DetectorATLASConstruction;
)DICTFWDDCLS";
    static const char* payloadCode = R"DICTPAYLOAD(
#line 1 "libDetectorATLASModel dictionary payload"
...
"DetectorATLASConstruction", payloadCode, "@",
nullptr};

    static bool isInitialized = false;
    if (!isInitialized) {
      TROOT::RegisterModule("libDetectorATLASModel",
        headers, includePaths, payloadCode, fwdDeclCode,
        TriggerDictionaryInitialization_libDetectorATLASModel_Impl, {}, classesHeaders, /*has no C++ module*/false);
      isInitialized = true;
    }
  }
  static struct DictInit {
    DictInit() {
      TriggerDictionaryInitialization_libDetectorATLASModel_Impl();
    }
  } __TheDictionaryInitializer;
}
void TriggerDictionaryInitialization_libDetectorATLASModel() {
  TriggerDictionaryInitialization_libDetectorATLASModel_Impl();
}
