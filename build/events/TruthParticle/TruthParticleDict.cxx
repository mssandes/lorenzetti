...
#define R__DICTIONARY_FILENAME TruthParticleDict
...
#include "/home/marton.sandes/lzt/lorenzetti/events/TruthParticle/TruthParticle/TruthParticle.h"
#include "/home/marton.sandes/lzt/lorenzetti/events/TruthParticle/TruthParticle/TruthParticleContainer.h"
#include "/home/marton.sandes/lzt/lorenzetti/events/TruthParticle/TruthParticle/TruthParticleConverter.h"
#include "TruthParticle/TruthParticleConverter.h"

// Header files passed via #pragma extra_include

namespace ROOT {
   static TClass *xAODcLcLTruthParticle_t_Dictionary();
   static void xAODcLcLTruthParticle_t_TClassManip(TClass*);
   static void *new_xAODcLcLTruthParticle_t(void *p = 0);
   static void *newArray_xAODcLcLTruthParticle_t(Long_t size, void *p);
   static void delete_xAODcLcLTruthParticle_t(void *p);
   static void deleteArray_xAODcLcLTruthParticle_t(void *p);
   static void destruct_xAODcLcLTruthParticle_t(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::xAOD::TruthParticle_t*)
   {
      ::xAOD::TruthParticle_t *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TIsAProxy(typeid(::xAOD::TruthParticle_t));
      static ::ROOT::TGenericClassInfo 
         instance("xAOD::TruthParticle_t", "TruthParticle/TruthParticleConverter.h", 9,
                  typeid(::xAOD::TruthParticle_t), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &xAODcLcLTruthParticle_t_Dictionary, isa_proxy, 4,
                  sizeof(::xAOD::TruthParticle_t) );
      instance.SetNew(&new_xAODcLcLTruthParticle_t);
      instance.SetNewArray(&newArray_xAODcLcLTruthParticle_t);
      instance.SetDelete(&delete_xAODcLcLTruthParticle_t);
      instance.SetDeleteArray(&deleteArray_xAODcLcLTruthParticle_t);
      instance.SetDestructor(&destruct_xAODcLcLTruthParticle_t);
      return &instance;
   }
   TGenericClassInfo *GenerateInitInstance(const ::xAOD::TruthParticle_t*)
   {
      return GenerateInitInstanceLocal((::xAOD::TruthParticle_t*)0);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::xAOD::TruthParticle_t*)0x0); R__UseDummy(_R__UNIQUE_DICT_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *xAODcLcLTruthParticle_t_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal((const ::xAOD::TruthParticle_t*)0x0)->GetClass();
      xAODcLcLTruthParticle_t_TClassManip(theClass);
   return theClass;
   }
...
namespace ROOT {
   ...
   static void *new_xAODcLcLTruthParticle_t(void *p) {
      return  p ? ::new((::ROOT::Internal::TOperatorNewHelper*)p) ::xAOD::TruthParticle_t : new ::xAOD::TruthParticle_t;
   }
   static void *newArray_xAODcLcLTruthParticle_t(Long_t nElements, void *p) {
      return p ? ::new((::ROOT::Internal::TOperatorNewHelper*)p) ::xAOD::TruthParticle_t[nElements] : new ::xAOD::TruthParticle_t[nElements];
   }
   // Wrapper around operator delete
   static void delete_xAODcLcLTruthParticle_t(void *p) {
      delete ((::xAOD::TruthParticle_t*)p);
   }
   static void deleteArray_xAODcLcLTruthParticle_t(void *p) {
      delete [] ((::xAOD::TruthParticle_t*)p);
   }
   static void destruct_xAODcLcLTruthParticle_t(void *p) {
      typedef ::xAOD::TruthParticle_t current_t;
      ((current_t*)p)->~current_t();
   }
} // end of namespace ROOT for class ::xAOD::TruthParticle_t

namespace ROOT {
   static TClass *vectorlExAODcLcLTruthParticle_tgR_Dictionary();
   static void vectorlExAODcLcLTruthParticle_tgR_TClassManip(TClass*);
   static void *new_vectorlExAODcLcLTruthParticle_tgR(void *p = 0);
   static void *newArray_vectorlExAODcLcLTruthParticle_tgR(Long_t size, void *p);
   static void delete_vectorlExAODcLcLTruthParticle_tgR(void *p);
   static void deleteArray_vectorlExAODcLcLTruthParticle_tgR(void *p);
   static void destruct_vectorlExAODcLcLTruthParticle_tgR(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<xAOD::TruthParticle_t>*)
   {
      vector<xAOD::TruthParticle_t> *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TIsAProxy(typeid(vector<xAOD::TruthParticle_t>));
      static ::ROOT::TGenericClassInfo 
         instance("vector<xAOD::TruthParticle_t>", -2, "vector", 216,
                  typeid(vector<xAOD::TruthParticle_t>), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &vectorlExAODcLcLTruthParticle_tgR_Dictionary, isa_proxy, 4,
                  sizeof(vector<xAOD::TruthParticle_t>) );
      instance.SetNew(&new_vectorlExAODcLcLTruthParticle_tgR);
      instance.SetNewArray(&newArray_vectorlExAODcLcLTruthParticle_tgR);
      instance.SetDelete(&delete_vectorlExAODcLcLTruthParticle_tgR);
      instance.SetDeleteArray(&deleteArray_vectorlExAODcLcLTruthParticle_tgR);
      instance.SetDestructor(&destruct_vectorlExAODcLcLTruthParticle_tgR);
      instance.AdoptCollectionProxyInfo(TCollectionProxyInfo::Generate(TCollectionProxyInfo::Pushback< vector<xAOD::TruthParticle_t> >()));
      return &instance;
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const vector<xAOD::TruthParticle_t>*)0x0); R__UseDummy(_R__UNIQUE_DICT_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *vectorlExAODcLcLTruthParticle_tgR_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal((const vector<xAOD::TruthParticle_t>*)0x0)->GetClass();
      vectorlExAODcLcLTruthParticle_tgR_TClassManip(theClass);
   return theClass;
   }
...
namespace ROOT {
   // Wrappers around operator new
   static void *new_vectorlExAODcLcLTruthParticle_tgR(void *p) {
      return  p ? ::new((::ROOT::Internal::TOperatorNewHelper*)p) vector<xAOD::TruthParticle_t> : new vector<xAOD::TruthParticle_t>;
   }
   static void *newArray_vectorlExAODcLcLTruthParticle_tgR(Long_t nElements, void *p) {
      return p ? ::new((::ROOT::Internal::TOperatorNewHelper*)p) vector<xAOD::TruthParticle_t>[nElements] : new vector<xAOD::TruthParticle_t>[nElements];
   }
   // Wrapper around operator delete
   static void delete_vectorlExAODcLcLTruthParticle_tgR(void *p) {
      delete ((vector<xAOD::TruthParticle_t>*)p);
   }
   static void deleteArray_vectorlExAODcLcLTruthParticle_tgR(void *p) {
      delete [] ((vector<xAOD::TruthParticle_t>*)p);
   }
   static void destruct_vectorlExAODcLcLTruthParticle_tgR(void *p) {
      typedef vector<xAOD::TruthParticle_t> current_t;
      ((current_t*)p)->~current_t();
   }
} // end of namespace ROOT for class vector<xAOD::TruthParticle_t>

namespace {
  void TriggerDictionaryInitialization_libTruthParticle_Impl() {
    static const char* headers[] = {
"/home/marton.sandes/lzt/lorenzetti/events/TruthParticle/TruthParticle/TruthParticle.h",
"/home/marton.sandes/lzt/lorenzetti/events/TruthParticle/TruthParticle/TruthParticleContainer.h",
"/home/marton.sandes/lzt/lorenzetti/events/TruthParticle/TruthParticle/TruthParticleConverter.h",
0
    };
...
"/home/marton.sandes/lzt/lorenzetti/events/TruthParticle",
"/home/marton.sandes/lzt/lorenzetti/events/TruthParticle/../../core/GaugiKernel",
"/home/marton.sandes/lzt/lorenzetti/events/TruthParticle/../CaloCell",
"/home/marton.sandes/lzt/lorenzetti/events/TruthParticle/../CaloCluster",
"/opt/root/buildthis/include",
"/home/marton.sandes/lzt/lorenzetti/build/events/TruthParticle/",
0
    };
    static const char* fwdDeclCode = R"DICTFWDDCLS(
#line 1 "libTruthParticle dictionary forward declarations' payload"
#pragma clang diagnostic ignored "-Wkeyword-compat"
#pragma clang diagnostic ignored "-Wignored-attributes"
#pragma clang diagnostic ignored "-Wreturn-type-c-linkage"
extern int __Cling_Autoloading_Map;
namespace xAOD{struct __attribute__((annotate("$clingAutoload$TruthParticle/TruthParticleConverter.h")))  TruthParticle_t;}
namespace std{template <typename _Tp> class __attribute__((annotate("$clingAutoload$bits/allocator.h")))  __attribute__((annotate("$clingAutoload$string")))  allocator;
}
)DICTFWDDCLS";
    static const char* payloadCode = R"DICTPAYLOAD(
#line 1 "libTruthParticle dictionary payload"
...
"xAOD::TruthParticle_t", payloadCode, "@",
nullptr};

    static bool isInitialized = false;
    if (!isInitialized) {
      TROOT::RegisterModule("libTruthParticle",
        headers, includePaths, payloadCode, fwdDeclCode,
        TriggerDictionaryInitialization_libTruthParticle_Impl, {}, classesHeaders, /*has no C++ module*/false);
      isInitialized = true;
    }
  }
  static struct DictInit {
    DictInit() {
      TriggerDictionaryInitialization_libTruthParticle_Impl();
    }
  } __TheDictionaryInitializer;
}
void TriggerDictionaryInitialization_libTruthParticle() {
  TriggerDictionaryInitialization_libTruthParticle_Impl();
}
