...
#define R__DICTIONARY_FILENAME CaloClusterXTDict
...
namespace {
  void TriggerDictionaryInitialization_libCaloClusterXT_Impl() {
...
#line 1 "libCaloClusterXT dictionary forward declarations' payload"
...
#line 1 "libCaloClusterXT dictionary payload"
...
nullptr};
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("libCaloClusterXT",
        headers, includePaths, payloadCode, fwdDeclCode,
        TriggerDictionaryInitialization_libCaloClusterXT_Impl, {}, classesHeaders, /*has no C++ module*/false);
      isInitialized = true;
    }
  }
  static struct DictInit {
    DictInit() {
      TriggerDictionaryInitialization_libCaloClusterXT_Impl();
    }
  } __TheDictionaryInitializer;
}
void TriggerDictionaryInitialization_libCaloClusterXT() {
  TriggerDictionaryInitialization_libCaloClusterXT_Impl();
}
